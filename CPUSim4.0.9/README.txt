...
1.  Download the CPUSim4.0.9.zip file onto your hard disk.

2.  Unzip the CPUSim4.0.9.zip file. The unzipping process
will create a folder called "CPUSim4.0.9" containing 4
